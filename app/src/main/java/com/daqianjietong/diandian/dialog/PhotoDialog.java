...
public class PhotoDialog implements OnClickListener {
	...
	public PhotoDialog(final Context context, Handler handler) {
		...
		view = View.inflate(context, R.layout.photo_choose_dialog, null);
		d.setContentView(view);
		camara = (TextView) d.findViewById(R.id.openCamera);
		photo = (TextView) d.findViewById(R.id.openPhones);
